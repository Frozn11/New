...
csv_file = 'steam_store_data_2024.csv'
db_file = 'steam_store_data_2024.db'
table_name = 'data'
columns = ['title','description','price','salePercentage','recentReviews','allReviews']  # Замените на реальные названия столбцов из вашего CSV
